...
export default function CTA({ text, link, openInNewTab }: CTAType) {
  ...
  if (openInNewTab) {
    return (
      <a
        ...
        after:absolute after:h-2/4 after:w-0.5 after:-top-1/4 after:left-0 after:bg-secondary after:transition-transform after:translate-y-0
        hover:before:-translate-y-1/4 hover:after:translate-y-1/4'
      >
        <span
          className='inline-block relative p-2 
          after:absolute after:w-9/12 after:h-0.5 after:top-0 after:left-0 after:bg-secondary after:transition-transform after:translate-x-0
          before:absolute before:w-9/12 before:h-0.5 before:bottom-0 before:right-0 before:bg-secondary before:transition-transform bg:translate-x-0
  ...
  return (
    ...
    >
      <span
        className='inline-block relative py-2 px-4 
          after:absolute after:w-9/12 after:h-0.5 after:top-0 after:left-0 after:bg-secondary after:transition-transform after:translate-x-0
          before:absolute before:w-9/12 before:h-0.5 before:bottom-0 before:right-0 before:bg-secondary before:transition-transform bg:translate-x-0
          hover:after:-translate-x-1/4 hover:before:translate-x-1/4
          '
